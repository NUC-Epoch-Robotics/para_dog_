// Optional single-file build of SimpleMatrix. Disabled by default to avoid
// duplicate definitions with simple_matrix.c. Define SIMPLE_MATRIX_SINGLE_FILE
// if you intentionally want to compile this translation unit instead.
#if defined(SIMPLE_MATRIX_SINGLE_FILE)
...
#endif /* SIMPLE_MATRIX_SINGLE_FILE */
