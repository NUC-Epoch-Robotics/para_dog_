...
void walkForward(Dog *dog){
	static const bezierPoint ctrl_point[4][4]={
		{{0 ,190.53f},{12.5,100.0f},{25.0f,190.53f},{100,190.53f}},	//STEP_FORE1
		{{0,190.53},{-12.5f,200.0f},{-25.0f,190.53},{ 99,214}},		//KICK_BACK1
		{{-25.0f,190.53f},{-30,100.0f},{30,100.0f},{25.0f,190.53f}},	//STEP_FORE2
		{{25.0f,190.53},{0,200.0f},{-25.0f,190.53f},{ 99,214}},			//KICK_BACK2
		 };
	// 初始化所有控制点为 {0,0}.pos = {0.0f, 0.0f},.now_time = 0,.last_end_time = 0
	static bezier_exp bezier_exp[4] = {
		{.T = 0.14f,.fre = 100.0f,.n = 2,.pid={.K_P=0.3f,.K_W=0.01f,.Pos=0,.W=0,.T=0},.t = 0.0f,.point_sum = 0,.flag = 0,.ctrl_point = { 0} ,.pos = {0.0f, 0.0f},.now_time = 0,.last_end_time = 0},
		{.T = 0.14f,.fre = 100.0f,.n = 2,.pid={.K_P=0.3f,.K_W=0.01f,.Pos=0,.W=0,.T=0},.t = 0.0f,.point_sum = 0,.flag = 0,.ctrl_point = { 0 } ,.pos = {0.0f, 0.0f},.now_time = 0,.last_end_time = 0},
		{.T = 0.14f,.fre = 100.0f,.n = 3,.pid={.K_P=0.3f,.K_W=0.01f,.Pos=0,.W=0,.T=0},.t = 0.0f,.point_sum = 0,.flag = 0,.ctrl_point = { 0} ,.pos = {0.0f, 0.0f},.now_time = 0,.last_end_time = 0},
		{.T = 0.14f,.fre = 100.0f,.n = 2,.pid={.K_P=0.3f,.K_W=0.01f,.Pos=0,.W=0,.T=0},.t = 0.0f,.point_sum = 0,.flag = 0,.ctrl_point = {0 } ,.pos = {0.0f, 0.0f},.now_time = 0,.last_end_time = 0},
	};
	for(uint8_t i=0;i<4;i++){
