...
#define SET_485_DE_UP() HAL_GPIO_WritePin(GPIOA,GPIO_PIN_8, GPIO_PIN_SET)
#define SET_485_DE_DOWN() HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_RESET)

#define SET_485_RE_UP() HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_SET)
#define SET_485_RE_DOWN() HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_RESET)
