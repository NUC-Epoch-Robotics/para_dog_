...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define RC_AUTO_ENABLE 1//1=RC;0=AUTO
...
osThreadId Auto_OffRoadTaskHandle;
...
void Auto_OffRoad(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  #elif RC_AUTO_ENABLE==0
  osThreadDef(Auto_OffRoadTask, Auto_OffRoad, osPriorityNormal, 0, 512);
  Auto_OffRoadTaskHandle = osThreadCreate(osThread(Auto_OffRoadTask), NULL);
  #endif
